...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2016 at 03:37 PM
...
INSERT INTO `ck_contacts` (`contact_id`, `first_name`, `middle_name`, `last_name`, `display_name`, `phone_number`, `email`, `contact_image`, `type`, `address_line_1`, `address_line_2`, `city`, `state`, `postal_code`, `country`) VALUES
(1, 'Nguyen', 'Minh', 'Duc', 'Nguyen Minh Duc', '+84968280264', 'hellpoethero1994@gmail.com', '', '', 'C34, Alley 76, Duy Tan Str, Cau Giay District, Ha Noi', 'C34, Alley 76, Duy Tan Str, Cau Giay District, Ha Noi', 'Hanoi', '', '10000', 'Vi?t Nam'),
(2, 'Nguyen', 'Minh', 'Duc', 'Nguyen Minh Duc', '+84968280264', '', '', '', 'C34, Alley 76, Duy Tan Str, Cau Giay District, Ha Noi', 'C34, Alley 76, Duy Tan Str, Cau Giay District, Ha Noi', 'Hanoi', '', '10000', 'Vi?t Nam'),
(3, 'Chu', 'Chi', 'Quang', 'Chu Chi Quang', '0969696969', 'quangcc@vnu.edu.vn', '', 'Home', 'abc', 'xyz', 'HN', 'HN', '000001', 'VN'),
(4, 'Vu', 'Ngoc', 'Thanh', 'Vu Ngoc Thanh', '0918484495', 'thanhvn@vnu.edu.vn', '', 'Home', 'a', 'b', '?d', '324', '34546', 'vn'),
(5, 'Vu', 'Ngoc', 'Thanh', 'Vu Ngoc Thanh', '0918484495', 'thanhvn@vnu.edu.vn', '', 'Home', 'a', 'b', '?d', '324', '34546', 'vn'),
(6, 'Nguyen', 'Van', 'A', 'Nguyen Van A', '252', 'a@b.com', '', 'Home', 'abc', 'v', 'v', 'v', '1', 'a'),
(7, 'Pham', 'Van', 'Phi', 'Pham Van Phi', 'f', 'phi@vnu.edu.vn', '', 'Home', 'a', 'b', 'c', 'd', '1', 'e');
...
(2, 'default_timezone', 'Asia/Ho_Chi_Minh'),
...
INSERT INTO `ck_patient` (`patient_id`, `contact_id`, `patient_since`, `display_id`, `followup_date`, `reference_by`, `gender`, `dob`) VALUES
(1, 1, '2015-12-22', 'D00001', '0000-00-00', '', 'male', '1995-01-12'),
(2, 2, '2015-12-22', 'D00002', '0000-00-00', '', 'male', NULL),
(3, 3, '2015-12-29', 'Q00003', '0000-00-00', 'k biet', 'male', '1994-11-07'),
(4, 4, '2015-12-29', 'T00004', '0000-00-00', 'b', 'male', '1994-08-28'),
(5, 5, '2015-12-29', 'T00005', '0000-00-00', 'b', 'male', '1994-08-28'),
(6, 6, '2015-12-30', 'A00006', '0000-00-00', 'd', 'male', '2000-05-08'),
(7, 7, '2015-12-31', 'P00007', '0000-00-00', 'a', 'male', '1994-11-01');
...
(2, 'Nguyen Minh Duc', 'duc001', 'ZHVj', 'Doctor', 1);
...
--
CREATE TABLE `ck_view_bill_detail_report` (
`bill_id` int(11)
,`bill_date` date
,`visit_id` int(11)
...
--
CREATE TABLE `ck_view_contact_email` (
`contact_id` int(11)
,`email` varchar(150)
);
...
,`waiting_in` time
,`waiting_duration` bigint(12)
,`consultation_in` time
,`consultation_out` time
,`consultation_duration` bigint(12)
,`waiting_out` time
...
--
CREATE TABLE `ck_view_visit_treatments` (
`visit_id` int(11)
,`particular` varchar(50)
,`type` varchar(25)
);
